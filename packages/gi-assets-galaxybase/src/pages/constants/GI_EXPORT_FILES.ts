export const GI_SERVICES_OPTIONS = [
  ...
  },
  {
    ...
    name: 'MOCK/Save',
    content:
      "export default function service(params, localData) {\n      var uuid = \"\".concat(Math.random().toString(36).substr(2));\n      var href = window.location.origin + '/#/share/' + uuid; //  window.localforage 是 G6VP 平台提供的全局变量，详情参考：https://github.com/localForage/localForage\n      //@ts-ignore\n\n      var _window = window,\n          localforage = _window.localforage;\n      localforage.setItem(uuid, {\n        id: uuid,\n        type: 'save',\n        params: JSON.stringify(params)\n      });\n      return new Promise(function (resolve) {\n        return resolve({\n          success: true,\n          data: href\n        });\n      });\n    }",
  },
  {
...
export const GI_PROJECT_CONFIG = {
  ...
  components: [
    ...
    },
    {
      ...
      name: '侧边栏',
      props: {
        GI_CONTAINER: ['GremlinQuery', 'FilterPanel', 'PathAnalysis', 'StyleSetting', 'Save'],
